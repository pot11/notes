...
${patientName}有一个${doctorName}医生的${reserveService}将会在${reserveTime}开始，请点击https://hospital-api.ybbhealth.com/admin/appRedirect/${shortCode}，进入问诊诊室等待医生发起邀请
...
${doctorName}医生邀请您完成《${questionName}》，请及时填写，谢谢～ 点击https://hospital-api.ybbhealth.com/admin/appRedirect/${shortCode}，拒收请回复R
