...
${patientName}患者与您预约的${inquiryTime}的${inquiryType}问诊将在${minutes}分钟后开始，点击https://hospital-api.ybbhealth.com/admin/appRedirect/${shortCode}，进入诊室
...
已通知${patientName}患者${planContent}，点击https://hospital-api.ybbhealth.com/admin/appRedirect/${shortCode}，查看计划
...
短信模版：您有一项${patientName}患者的${itemType}待办事项需要处理，请及时处理https://hospital-api.ybbhealth.com/admin/appRedirect/${shortCode}
跳转：app待办事项的医生回访页面
