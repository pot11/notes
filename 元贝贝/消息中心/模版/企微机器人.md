...
【医生标记】${doctorName}医生给${patientName}患者进行标记，内容如下:${signContent}可点击进行查看[{短链，跳转到后台患者详情的的医生标记信息中的对应医生位置}](https://hospital-test.ybbhealth.com/patientManger/todo/index)
跳转：
